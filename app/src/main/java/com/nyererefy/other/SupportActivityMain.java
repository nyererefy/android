...
public class SupportActivityMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kInstagramBtn.setOnClickListener(view -> openInstagram("nyererefy"));
        ...
        kWebBtn.setOnClickListener(view -> openBrowser("https://nyererefy.com"));
        kFacebookBtn.setOnClickListener(view -> openFacebookPage("nyererefy", "1967247010153586"));
        ...
        kTwitterBtn.setOnClickListener(view -> openTwitter("nyererefy"));
    }
    ...
    private void openGmail() {
        ...
        String[] recipients = {"nyererefy@gmail.com"};
